...
Исправить публикацию фото на странице «Über uns» и headless AGY
...
- считать soft-deny разрешений AGY ошибкой, а не успешным no-op
...
- production AGY smoke после `toolPermission=proceed-in-sandbox` создал ожидаемый diff в `content.pages.about.blocks`; тестовый asset и diff откатились автоматически
